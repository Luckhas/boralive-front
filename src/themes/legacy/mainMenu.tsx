...
export default function MainMenu() {
  return (
    <Menu className="w-full bg-bl-dark-purple">
      <nav id="mainMenu" className="flex max-w-6xl mx-auto items-center justify-between py-5">
        ...
        <div className="bg-gray-500 p-2">
          <form action="">
            ...
            <div className="flex">
              <div id="searchBarIcon" className="">
              ...
              <input type="search" id="searchBarInput" className='' placeholder="Buscar por cursos, downloads, temas..."/>
              <button type="submit" className="text-sm p-4">Buscar</button>
            </div>
          </form>
        </div>
      </nav>
